...
_G.packer_plugins = {
  ...
  ["nvim-dap-view"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-dap-view",
  ...
  ["remote-nvim.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/remote-nvim.nvim",
    url = "https://github.com/amitds1997/remote-nvim.nvim"
  },
  ["smear-cursor.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/smear-cursor.nvim",
